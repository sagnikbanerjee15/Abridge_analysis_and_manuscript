...
setnames(all_info_RNA_Seq_SE, "t_decompress_cram", "CRAM")
...
all_info_RNA_Seq_PE$num_reads <- as.numeric(all_info_RNA_Seq_PE$num_reads)
order(all_info_RNA_Seq_PE$num_reads)
all_info_RNA_Seq_PE <- cbind(all_info_RNA_Seq_PE[, c("num_reads", "t_decompress_cram", "t_decompress_deez_lossy_0_mode_1",
                                                     "t_decompress_samcomp",
                                                     "t_decompress_genozip_optimize__compression_best",
                                                     "t_decompress_csam_q_0_m_0")],
                             all_info_RNA_Seq_PE[, grep(pattern="^t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores",colnames(all_info_RNA_Seq_PE)) ])

setnames(all_info_RNA_Seq_PE, "t_decompress_csam_q_0_m_0", "CSAM")
setnames(all_info_RNA_Seq_PE, "t_decompress_cram", "CRAM")
setnames(all_info_RNA_Seq_PE, "t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores_br", "ABRIDGE_BR")
setnames(all_info_RNA_Seq_PE, "t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores_7z", "ABRIDGE_7z")
setnames(all_info_RNA_Seq_PE, "t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores_zpaq", "ABRIDGE_ZPAQ")
setnames(all_info_RNA_Seq_PE, "t_decompress_deez_lossy_0_mode_1", "DEEZ")
setnames(all_info_RNA_Seq_PE, "t_decompress_samcomp", "SAMCOMP")
setnames(all_info_RNA_Seq_PE, "t_decompress_genozip_optimize__compression_best", "GENOZIP")
...
all_info_DNA_Seq_SE$num_reads <- as.numeric(all_info_DNA_Seq_SE$num_reads)
order(all_info_DNA_Seq_SE$num_reads)
all_info_DNA_Seq_SE <- cbind(all_info_DNA_Seq_SE[, c("num_reads", "t_decompress_cram", "t_decompress_deez_lossy_0_mode_1",
                                                     "t_decompress_samcomp",
                                                     "t_decompress_genozip_optimize__compression_best",
                                                     "t_decompress_csam_q_0_m_0")],
                             all_info_DNA_Seq_SE[, grep(pattern="^t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores",colnames(all_info_DNA_Seq_SE)) ])

setnames(all_info_DNA_Seq_SE, "t_decompress_csam_q_0_m_0", "CSAM")
setnames(all_info_DNA_Seq_SE, "t_decompress_cram", "CRAM")
setnames(all_info_DNA_Seq_SE, "t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores_br", "ABRIDGE_BR")
setnames(all_info_DNA_Seq_SE, "t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores_7z", "ABRIDGE_7z")
setnames(all_info_DNA_Seq_SE, "t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores_zpaq", "ABRIDGE_ZPAQ")
setnames(all_info_DNA_Seq_SE, "t_decompress_deez_lossy_0_mode_1", "DEEZ")
setnames(all_info_DNA_Seq_SE, "t_decompress_samcomp", "SAMCOMP")
setnames(all_info_DNA_Seq_SE, "t_decompress_genozip_optimize__compression_best", "GENOZIP")
...
all_info_DNA_Seq_PE$num_reads <- as.numeric(all_info_DNA_Seq_PE$num_reads)
order(all_info_DNA_Seq_PE$num_reads)
all_info_DNA_Seq_PE <- cbind(all_info_DNA_Seq_PE[, c("num_reads", "t_decompress_cram", "t_decompress_deez_lossy_0_mode_1",
                                                     "t_decompress_samcomp",
                                                     "t_decompress_genozip_optimize__compression_best",
                                                     "t_decompress_csam_q_0_m_0")],
                             all_info_DNA_Seq_PE[, grep(pattern="^t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores",colnames(all_info_DNA_Seq_PE)) ])

setnames(all_info_DNA_Seq_PE, "t_decompress_csam_q_0_m_0", "CSAM")
setnames(all_info_DNA_Seq_PE, "t_decompress_cram", "CRAM")
setnames(all_info_DNA_Seq_PE, "t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores_br", "ABRIDGE_BR")
setnames(all_info_DNA_Seq_PE, "t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores_7z", "ABRIDGE_7z")
setnames(all_info_DNA_Seq_PE, "t_decompress_abridge_save_all_quality_scores_save_exact_quality_scores_zpaq", "ABRIDGE_ZPAQ")
setnames(all_info_DNA_Seq_PE, "t_decompress_deez_lossy_0_mode_1", "DEEZ")
setnames(all_info_DNA_Seq_PE, "t_decompress_samcomp", "SAMCOMP")
setnames(all_info_DNA_Seq_PE, "t_decompress_genozip_optimize__compression_best", "GENOZIP")
...
all_info_RNA_Seq_SE$num_reads <- as.numeric(all_info_RNA_Seq_SE$num_reads)
order(all_info_RNA_Seq_SE$num_reads)
all_info_RNA_Seq_SE <- cbind(all_info_RNA_Seq_SE[, c("num_reads", "t_cram", "t_compress_deez_lossy_0_mode_1",
                                                     "t_compress_samcomp",
                                                     "t_compress_genozip_optimize__compression_best",
                                                     "t_compress_csam_q_0_m_0")],
                             all_info_RNA_Seq_SE[, grep(pattern="^t_compress_abridge_save_all_quality_scores_save_exact_quality_scores",colnames(all_info_RNA_Seq_SE)) ])

setnames(all_info_RNA_Seq_SE, "t_compress_csam_q_0_m_0", "CSAM")
setnames(all_info_RNA_Seq_SE, "t_cram", "CRAM")
setnames(all_info_RNA_Seq_SE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_br", "ABRIDGE_BR")
setnames(all_info_RNA_Seq_SE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_7z", "ABRIDGE_7z")
setnames(all_info_RNA_Seq_SE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_zpaq", "ABRIDGE_ZPAQ")
setnames(all_info_RNA_Seq_SE, "t_compress_deez_lossy_0_mode_1", "DEEZ")
setnames(all_info_RNA_Seq_SE, "t_compress_samcomp", "SAMCOMP")
setnames(all_info_RNA_Seq_SE, "t_compress_genozip_optimize__compression_best", "GENOZIP")
...
all_info_RNA_Seq_PE$num_reads <- as.numeric(all_info_RNA_Seq_PE$num_reads)
order(all_info_RNA_Seq_PE$num_reads)
all_info_RNA_Seq_PE <- cbind(all_info_RNA_Seq_PE[, c("num_reads", "t_cram", "t_compress_deez_lossy_0_mode_1",
                                                     "t_compress_samcomp",
                                                     "t_compress_genozip_optimize__compression_best",
                                                     "t_compress_csam_q_0_m_0")],
                             all_info_RNA_Seq_PE[, grep(pattern="^t_compress_abridge_save_all_quality_scores_save_exact_quality_scores",colnames(all_info_RNA_Seq_PE)) ])

setnames(all_info_RNA_Seq_PE, "t_compress_csam_q_0_m_0", "CSAM")
setnames(all_info_RNA_Seq_PE, "t_cram", "CRAM")
setnames(all_info_RNA_Seq_PE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_br", "ABRIDGE_BR")
setnames(all_info_RNA_Seq_PE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_7z", "ABRIDGE_7z")
setnames(all_info_RNA_Seq_PE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_zpaq", "ABRIDGE_ZPAQ")
setnames(all_info_RNA_Seq_PE, "t_compress_deez_lossy_0_mode_1", "DEEZ")
setnames(all_info_RNA_Seq_PE, "t_compress_samcomp", "SAMCOMP")
setnames(all_info_RNA_Seq_PE, "t_compress_genozip_optimize__compression_best", "GENOZIP")
...
all_info_DNA_Seq_SE$num_reads <- as.numeric(all_info_DNA_Seq_SE$num_reads)
order(all_info_DNA_Seq_SE$num_reads)
all_info_DNA_Seq_SE <- cbind(all_info_DNA_Seq_SE[, c("num_reads", "t_cram", "t_compress_deez_lossy_0_mode_1",
                                                     "t_compress_samcomp",
                                                     "t_compress_genozip_optimize__compression_best",
                                                     "t_compress_csam_q_0_m_0")],
                             all_info_DNA_Seq_SE[, grep(pattern="^t_compress_abridge_save_all_quality_scores_save_exact_quality_scores",colnames(all_info_DNA_Seq_SE)) ])

setnames(all_info_DNA_Seq_SE, "t_compress_csam_q_0_m_0", "CSAM")
setnames(all_info_DNA_Seq_SE, "t_cram", "CRAM")
setnames(all_info_DNA_Seq_SE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_br", "ABRIDGE_BR")
setnames(all_info_DNA_Seq_SE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_7z", "ABRIDGE_7z")
setnames(all_info_DNA_Seq_SE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_zpaq", "ABRIDGE_ZPAQ")
setnames(all_info_DNA_Seq_SE, "t_compress_deez_lossy_0_mode_1", "DEEZ")
setnames(all_info_DNA_Seq_SE, "t_compress_samcomp", "SAMCOMP")
setnames(all_info_DNA_Seq_SE, "t_compress_genozip_optimize__compression_best", "GENOZIP")
...
all_info_DNA_Seq_PE$num_reads <- as.numeric(all_info_DNA_Seq_PE$num_reads)
order(all_info_DNA_Seq_PE$num_reads)
all_info_DNA_Seq_PE <- cbind(all_info_DNA_Seq_PE[, c("num_reads", "t_cram", "t_compress_deez_lossy_0_mode_1",
                                                     "t_compress_samcomp",
                                                     "t_compress_genozip_optimize__compression_best",
                                                     "t_compress_csam_q_0_m_0")],
                             all_info_DNA_Seq_PE[, grep(pattern="^t_compress_abridge_save_all_quality_scores_save_exact_quality_scores",colnames(all_info_DNA_Seq_PE)) ])

setnames(all_info_DNA_Seq_PE, "t_compress_csam_q_0_m_0", "CSAM")
setnames(all_info_DNA_Seq_PE, "t_cram", "CRAM")
setnames(all_info_DNA_Seq_PE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_br", "ABRIDGE_BR")
setnames(all_info_DNA_Seq_PE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_7z", "ABRIDGE_7z")
setnames(all_info_DNA_Seq_PE, "t_compress_abridge_save_all_quality_scores_save_exact_quality_scores_zpaq", "ABRIDGE_ZPAQ")
setnames(all_info_DNA_Seq_PE, "t_compress_deez_lossy_0_mode_1", "DEEZ")
setnames(all_info_DNA_Seq_PE, "t_compress_samcomp", "SAMCOMP")
setnames(all_info_DNA_Seq_PE, "t_compress_genozip_optimize__compression_best", "GENOZIP")
...
for_pie_chart_data$size <- for_pie_chart_data$size*100
